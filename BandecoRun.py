...
cont1 = 0; cont2 = 0; cont3 = 0; cont4 = 0; cont5 = 0 #controaldor dos numeros (loja)
...
uni_seg = 0
minutos = 1
tempo = 90 #sempre que alterar o tempo, mude o tempo na parte "APLICA CLICK NOS BOTÕES"
...
while True:
    ...
    if perdeu == 1 and prox == 0 and game_status == 1:            
        InterfaceDraw(fundos)
    ...
    if (int(tempo) == 0 or perdeu == 1) and prox == 1 and game_status == 1:
        InterfaceDraw(fundos)
        InterfaceDraw(final)
